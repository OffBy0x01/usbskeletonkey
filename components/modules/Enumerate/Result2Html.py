...
class Result2Html:
    ...
    def result2html(self, targets, ip_list):
        ...
        for dbg_ip in ip_list:
            info = targets[dbg_ip]
            self.result2html_dbg.debug(dbg_ip)
            self.result2html_dbg.debug(info.RESPONDS_ICMP)
            self.result2html_dbg.debug(info.RESPONDS_ARP)
            self.result2html_dbg.debug(info.MAC_ADDRESS)
            self.result2html_dbg.debug(info.ADAPTER_NAME)
            self.result2html_dbg.debug(info.ROUTE)
            self.result2html_dbg.debug(info.OS_INFO)
            self.result2html_dbg.debug(info.SOFTWARE_INFO)
            self.result2html_dbg.debug(info.WORKGROUP)
            self.result2html_dbg.debug(info.DOMAIN)
            self.result2html_dbg.debug(info.LOCAL)
            self.result2html_dbg.debug(info.SESSIONS)
            self.result2html_dbg.debug(info.NBT_STAT)
            self.result2html_dbg.debug(info.SHARE_INFO)
            self.result2html_dbg.debug(info.PASSWD_POLICY)
            self.result2html_dbg.debug(info.PRINTER_INFO)
            self.result2html_dbg.debug(info.PORTS)
